    ...
    <>
      <div className='container'>
        <ThemeProvider theme={customTheme}>
          <Container component="main" maxWidth="sm" sx={{ my: 5, pb: 5, borderRadius: "8px", /* border: { xs: "none", sm: "1px solid #25D366" }, */backgroundColor:{sm:"#111B21"},xs:"#0B141A",boxShadow:{sm:"0px 0px 5px 0px #FFF",xs:"none"} }}>
            <Container component="div" maxWidth="xs">
              ...
              >
                ...
                <Box component="form" onSubmit={submit} sx={{ mt: 3 }}>
                  ...
                  <ToggleButtonGroup sx={{ mt: 2, backgroundColor: "#0B141A" }}
                    value={role}
                    color="primary"
                    exclusive
                  ...
                  >
                    <ToggleButton variant="outlined"
                      value="mentor"
                      sx={{ backgroundColor: role === 'mentor' ? '#4CAF50' : '#0B141A'}}>
                      Quiero ser Mentor
                    </ToggleButton>
                    <ToggleButton
                      value="student"
                      sx={{ backgroundColor: role === 'student' ? '#4CAF50' : '#0B141A'}}>
